...
namespace CharacterSystem.Skill
{
    public class ProjectSkillCollider : MonoBehaviour, IAnimationStateHandler
    {
        ...
        public void Shooting(Vector3 target, DamageData damage)
        {
            ...
            Vector3 endPosition = IsometricUtility.ToVector3(transform.position, target).normalized * BulletRange;
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
                ...
                && (HitAll || hittedTargets.Count <= 0))
            {
                ...
                collision.gameObject.GetComponentInParent<CharacterActionController>().Hit(MyDamage);
