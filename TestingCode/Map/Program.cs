...
namespace Test
{
    class Program
    {
        ...
        static void GenerateMap(int mapScale, out ConsoleColor[,] map)
        {
        ...
        static void MakeBlock(int column, int row, int mapScale, ref ConsoleColor[,] map, ref Random random)
        {
        ...
        static void ShowMap(ConsoleColor[,] map)
        {
